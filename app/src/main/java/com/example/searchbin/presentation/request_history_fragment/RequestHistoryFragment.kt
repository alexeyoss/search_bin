...
@AndroidEntryPoint
class RequestHistoryFragment :
    Fragment(R.layout.fragment_request_history) {


    private var binding: FragmentRequestHistoryBinding? = null
    ...
    override fun onCreateView(
        ...
        val binding =
            FragmentRequestHistoryBinding.inflate(layoutInflater, container, false)
